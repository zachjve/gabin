    ...
    <div>
      <div className="mb-4 relative">
        ...
        <input 
          ...
          className="w-full pl-10 pr-4 py-2 rounded-lg border border-white/30 bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/50 text-white placeholder-white/50"
          value={searchTerm}
